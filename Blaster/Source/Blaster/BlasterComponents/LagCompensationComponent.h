...
private:
	...
	//frame history will store frame packages and it will only store history for a specified time. 
	//Once it has that much time worth of history, it's going to start discarding frame packages.
